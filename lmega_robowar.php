			...
			<div class="row">
				<div class="col-sm-12">
					<div class="headerText text-center">
						<h1><br><br><br>MEGA ROBOWARS<br><br></h1>
					</div>
				</div>
			</div>
...
<li>The traditional game of soccer played through the hands (or feet) of robots.</li><br>

<h4>Task</h4>
<li>To build a manually-controlled robot capable of playing soccer on an arena specially designed for robotic soccer match. The robot would compete against others in 1 vs 1, or 2 vs 2 matches.</li><br>
...
<li>Maximum bot size: 65 x 65 x 45 cm.</li>
<li>The weight limit of the robot for this competition is 50 kg.</li>
