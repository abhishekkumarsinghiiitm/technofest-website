...
<body data-spy="scroll" data-target="#navbarResponsive">
	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
		...
		<div class="caption text-center">
			<h1>Welcome to TECHNOFEST'19</h1>
...
<a class="btn bn-secondary btn-outline-dark btn-md" href="#register">REGISTER</a>			
		...
		<div class="jumbotron">
			<div class="narrow">
				...
				<div class="row text-center">
					...
					<div class="col-sm-3">
						<div class="placeBox">
							<a href="#technovation" id="imglink">
							<div class="imgBx">
					...
					<div class="col-sm-3">
						<div class="placeBox">
							<a href="#hackathon" id="imglink">
							<div class="imgBx">
								<img src="img/hackathon2.jpg" class="img-fluid">
							</div>
							<div class="content">
								<h3>HACKATHON</h3>
							</div>
					...
					<div class="col-sm-3">
						<div class="placeBox">
							<a href="#enterepreneur" id="imglink">
							<div class="imgBx">
								<img src="img/e2.jpg" class="img-fluid">
							</div>
							<div class="content">
								<h3>ENTEREPRENEURIAL EVENTS</h3>
							</div>
						</a>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="placeBox">
							<a href="#techkriti" id="imglink">
							<div class="imgBx">
								<img src="img/techkriti2.jpg" class="img-fluid">
							</div>
							<div class="content">
								<h3>TECHKRITI</h3>
							</div>
	...
	<div id="sponsors" class="offset">
		...
		<!---start register-->
	<div id="register" class="offset">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<div class="headerText text-center">
						<h1><br><br> REGISTER</h1>
					</div>
				</div>
			</div>
			...
			<div class="row clearfix">
				<div class="offset-sm-2 col-sm-2">
					<form>
						...
						<button class="btn btnD1">LOGIN</button>
					</form>
				</div>
			</div>
		</div>
