			...
			<div class="row">
				<div class="col-sm-12">
					<div class="headerText text-center">
						<h1><br><br><br>ROBO SOCCER<br><br></h1>
					</div>
				</div>
			</div>
...
<li>The traditional game of soccer played through the hands (or feet) of robots.
</li><br>
...
<li>Grabbing the ball is not allowed. The bots should not have any kind of grabbing mechanisms.</li><br>
<h4>General Rules</h4>
